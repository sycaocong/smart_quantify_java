...
public class BinanceAdapter implements ExchangeAdapter {
    private static final String CB_NAME = "binance-circuit-breaker";
    private static final String RL_NAME = "binance-rate-limiter";
    private static final String BH_NAME = "binance-bulkhead";
    ...
    public List<Kline> getKlinesFallback(String symbol, String interval, int limit, Throwable t) {
        log.warn("Binance getKlines fallback triggered: {}", t.getMessage());
    ...
    public OrderBook getOrderBookFallback(String symbol, int limit, Throwable t) {
        log.warn("Binance getOrderBook fallback triggered: {}", t.getMessage());
        return null;
    }
    ...
    public Ticker getTickerFallback(String symbol, Throwable t) {
        log.warn("Binance getTicker fallback triggered: {}", t.getMessage());
        return null;
    }
    ...
    public List<Instrument> getInstrumentsFallback(Throwable t) {
        log.warn("Binance getInstruments fallback triggered: {}", t.getMessage());
        return new ArrayList<>();
    }
    ...
    public com.smartquantify.common.model.Order placeOrderFallback(OrderRequest request, Throwable t) {
        log.warn("Binance placeOrder fallback triggered: {}", t.getMessage());
        return com.smartquantify.common.model.Order.builder()
                .id(java.util.UUID.randomUUID().toString())
                .symbol(request.getSymbol())
                .side(request.getSide())
    ...
    public com.smartquantify.common.model.Order getOrderFallback(String symbol, String orderId, Throwable t) {
        log.warn("Binance getOrder fallback triggered: {}", t.getMessage());
        return null;
    }
    ...
    public List<com.smartquantify.common.model.Order> getOpenOrdersFallback(String symbol, Throwable t) {
        log.warn("Binance getOpenOrders fallback triggered: {}", t.getMessage());
        return new ArrayList<>();
    }
